        ...
        function G=rates(obj,j1,j2,flag,V)
            ...
            if flag=='S'
                ...
                if obj.states(j1)>obj.states(j2)
                    ...
                    G=1e14*obj.J_s.transparency(d,dE,0)*ff_q(dE,obj.T);
            ...
            elseif flag=='D'
                ...
                if obj.states(j1)>obj.states(j2) % give an electron                    
                    dE=obj.spectr(j1)-obj.spectr(j2)-q*Vsd+q*vv;
                    G=1e14*obj.J_tip.transparency(d,obj.spectr(j1)-obj.spectr(j2),Vsd)*ff_q(dE,obj.T);                    
                else                           % take an electron                    
                    dE=-obj.spectr(j2)+obj.spectr(j1)+q*Vsd-q*vv;
                    G=1e14*obj.J_tip.transparency(d,-obj.spectr(j2)+obj.spectr(j1),Vsd)*ff_q(dE,obj.T);                    
                end;                                
            end;            
